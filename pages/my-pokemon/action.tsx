...
const MyPokemonAction = () => {
  ...
  const onRelease = () => {
    dispatch({type: 'ADD_MY_POKEMON', payload: { name: 'Mae', id: 1 }});
  }
    ...
    <DefaultLayout>
      { isSuccess ?
        <div css={container}>
          ...
          <div css={section}><span css={pokemonName}>{ data.pokemon.name }</span> was caught!</div>
        ...
        <div css={container}>
          ...
          <div css={section}>We have FAILED to catch <span css={pokemonName}>{ data.pokemon.name }</span>,<br/>it ran away!</div>
